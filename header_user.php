...
<body>
    ...
    <div>
      <div class="drawer">
        ...
        <div class="drawer-content">
          <label for="my-drawer" class="btn btn-outline btn-primary drawer-button">
            <svg
        ...
        <div class="drawer-side z-20">
          ...
          <div class="mt-10">
            ...
            <div>
                ...
                <div>
                  <a class="text-lg">Manage Forums</a>
                </div>
              </div>
            </li>
            <li>
      ...
      <a class="btn btn-ghost text-3xl">Cebu Eastern College</a>
    </div>
  ...
  <div class="flex w-full flex-col md:flex-row-1 lg:flex-col px-6 pt-24">
    ...
    <div class="card bg-base-300 rounded-md m-2 grid h-[400px] flex-grow place-items-center">
    </div>
  ...
  <footer class="footer footer-center bg-base-200 text-base-content rounded p-5">
    ...
    <aside>
      <p>Copyright © 2023-2024 - All right reserved by Cebu Eastern College</p>
    </aside>
</footer>
